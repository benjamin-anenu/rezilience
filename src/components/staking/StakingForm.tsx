 ...
 import { Check, AlertTriangle, Search, Coins, Clock } from 'lucide-react';
 ...
 export function StakingForm({ onFormChange }: StakingFormProps) {
   ...
   const verifyProgram = () => {
     // Mock verification
     const found = programs.find((p) => p.programId === programId || p.programId.includes(programId.slice(0, 8)));
     if (found) {
       setVerifiedProgram({ name: found.name, score: found.score });
       setStep(2);
       onFormChange({
           ...
           <div className="space-y-4">
             <div>
               ...
               <div className="mt-2 flex gap-2">
                 ...
                 {step === 1 && (
                   <Button onClick={verifyProgram} disabled={!programId}>
                     VERIFY
                   </Button>
                 )}
               </div>
